    ...
    return (
        <div className="relative">
            <div className={styles.aboutMeContainer}>
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="w-4/5 pl-5">
                        <p>
                            I’m a programmer with 8 years of experience in
                            learning and working with code, and 2 years of
                            hands-on experience in web development, mobile app
                            development, database design, system architecture,
                            and deployment.
                        </p>
                        <p>
                            I have a deep passion for knowledge — especially in
                            programming and technology — which has always been
                            the driving force behind my dedication to every
                            project I take on.
                        </p>
                    </div>
                </div>
            ...
            >
                ...
                >
                    <h3>
                        {expandItems.workExperienceExpanded
                            ? "Collapse"
                            : "Careers"}
                    </h3>
                </button>
