...
export default function FullstackJavaDoc() {
  return (
    <DocumentLayout
    ...
    >
      <DocumentSummary>
        ...
        <Text style={styles.bold}>2+ years of hands-on experience</Text> in web
        and mobile development. Skilled in{" "}
        <Text style={styles.bold}>Java, J2EE, OOP,</Text> and{" "}
        <Text style={styles.bold}>design patterns</Text>, with practical
        experience from academic and real-world projects. Proficient in{" "}
        <Text style={styles.bold}>ReactJS, HTML/CSS, REST APIs,</Text> and
        <Text style={styles.bold}>databases</Text>, with strong problem-solving,
        self-learning, and teamwork skills. Upper-intermediate English
        proficiency, eager to grow as a{" "}
        <Text style={styles.bold}>Java Software Engineer</Text> in an agile
        Scrum environment.
      </DocumentSummary>
      <DocumentEducation />
            ...
            jobs: [
              {
                ...
                description: [
                  <Text key={0}>
                    Designed and implemented backend services with Node.js,
                    applying OOP and design patterns to build scalable CRM
                    subsystems.
                  </Text>,
                  <Text key={1}>
                    Built the Social Integration Hub, a messaging service with
                    Redis queues and WebSocket for real-time features, improving
                    communication reliability across multiple platforms.
                  </Text>,
                  <Text key={2}>
                    Developed server-side logic and database schemas for
                    workflow and request management modules, ensuring data
                    integrity and efficiency.
                  </Text>,
                  <Text key={3}>
                    Integrated RESTful APIs from Shopee, TikTok Shop, Facebook,
                    and Zalo into CRM systems, enabling seamless data exchange
                    and authentication flows.
                  </Text>,
                  <Text key={4}>
                    Contributed to frontend development by building sales
                    reporting dashboards and supporting UI integration with
                  ...
                  <Text key={7}>
                    Managed DevOps workflows, deploying services with Docker,
                    GitHub Actions (CI/CD), and configuring Linux servers for
                    reliable production operations
                  </Text>,
                  <Text key={8}>
                    Collaborated in a Scrum-based team, gaining experience in
                    agile practices, documentation, and cross-team
                    communication.
                  </Text>,
                ],
              },
